/**
 * Vendored copy of `javascript-lp-solver` v1.0.3 (browser ESM build,
 * `dist/index.browser.mjs`), fetched from jsDelivr and checked in verbatim
 * (only the trailing `//# sourceMappingURL=...` comment was stripped, since
 * the matching .map file isn't vendored and this app runs fully offline).
 *
 * Source:  https://github.com/JWally/jsLPSolver
 * Package: https://www.npmjs.com/package/javascript-lp-solver
 * License: The Unlicense (public domain) — see the package's LICENSE file.
 *
 * Used by ../milp-solver.js as the branch-and-bound MILP/LP solver backing
 * the two alternative Sudoku solvers (binary-assignment and integer-cell
 * formulations). Not otherwise referenced by the app.
 */
